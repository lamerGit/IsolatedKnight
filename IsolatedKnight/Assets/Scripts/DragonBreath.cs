...
public class DragonBreath : Poolable
{
    int _damage;
    Vector3 _dir;
    float _speed;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            int totalDamage = Damage + Managers.Object.MyPlayer.PartnerDamage;
            other.GetComponent<EnemyBase>().OnPartnerDamage(totalDamage);
