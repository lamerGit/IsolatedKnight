...
public class Enemy_Knight : EnemyBase
{
    ...
    private void Die()
    {
        ...
        Managers.Object.MyPlayer.GoldUp(2);
    ...
    public override void Spawn(Transform t)
    {
        ...
        _agent.enabled = true;
        // Json 데이터 파싱
        SkelKnight skelKnight = null;
        Managers.Data.SkelKnightDict.TryGetValue(Managers.GameManager.GameLevel, out skelKnight);

        _level = skelKnight.level;
        _maxHp = skelKnight.maxHp;
        Hp = skelKnight.maxHp;
        _agent.speed = skelKnight.speed + Managers.GameManager.ExtraEnemySpeed;
        _exp = skelKnight.exp;
